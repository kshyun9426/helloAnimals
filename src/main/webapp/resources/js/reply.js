...
var reviewReplyService = (function(){
	...
	function add(reply, callback){
		...
		$.ajax({
			type : 'post',
			url : '/helloanimal/community/insert/reply',
	...
	function getList(param, callback, error){
		...
		var community_no = param.community_no;
		$.getJSON("/helloanimal/community/list/reply/" + community_no + ".json",
				function(data){
					if(callback){
						callback(data);
					}
	...
	//댓글 삭제
	function remove(replyInfo,callback, error){
		$.ajax({
			type : 'delete',
			url : "/helloanimal/community/delete/reply",
